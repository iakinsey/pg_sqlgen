...
-- Make the rust decode_text an internal functuin
ALTER FUNCTION sqlgen.decode_text(TEXT, TEXT) SET SCHEMA sqlgen_internal;
REVOKE EXECUTE ON FUNCTION sqlgen_internal.decode_text(TEXT, TEXT) FROM public;

-- Make the rust decode_text_batch an internal functuin
ALTER FUNCTION sqlgen.decode_text_batch(TEXT, TEXT) SET SCHEMA sqlgen_internal;
REVOKE EXECUTE ON FUNCTION sqlgen_internal.decode_text_batch(TEXT, TEXT[]) FROM public;